            ...
            <ul>
                {
                    ...
                    exps.map(exp => (
                        <li>
                            ...
                            <h3>Роль: {exp?.RoleName + " " + (exp?.RoleMainTechnology ? exp.RoleMainTechnology : "")}</h3>
                            <h3>Выполненные задачи: {exp?.CompletedTasksAmount}</h3>
                            <h3>Проваленные задачи: {exp?.FailedTasks}</h3>
